...
struct AboutContent: View {
    var body: some View {
        VStack{
            ...
            Text("À propos de ClickSpeed 2")
                .font(.largeTitle)
            
            Spacer()
            
            VStack{
                Text("Comparez-vous à vos amis en rigolant. À vos marques, prêts, cliquez ! Et tentez de devenir la légende du trackpad.\n\niStuces s'engage : ClickSpeed est et sera toujours gratuit.\n\n\nv2.0\n© 2023, iStuces\n")
